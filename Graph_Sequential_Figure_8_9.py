...
G.add_edge('fanout1','G1', value_non_fault='x',value_faulty='0',fault='sa0',cc0=0,cc1=0,co=0)


G.add_edge('A','fanout1', value_non_fault='x',value_faulty='x',fault='',cc0=1,cc1=1,co=0)
G.add_edge('B','FF1', value_non_fault='x',value_faulty='x',fault='',cc0=1,cc1=1,co=0)
